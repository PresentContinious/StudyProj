        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewOpportunities = table.Column<bool>(type: "bit", nullable: false),
                    GetDiploma = table.Column<bool>(type: "bit", nullable: false),
                    Skills = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Aim = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Occupation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WantedLevel = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentSessionId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DurationInMinutes = table.Column<long>(type: "bigint", nullable: true),
                    LessonId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, "Журналістика" },
                    { 7, "Іноземні мови" },
                    { 8, "Особистий розвиток" },
                    { 9, "Охорона здоров’я" },
                    { 10, "Підготовка до ЗНО" },
                    { 11, "Право" },
                    { 12, "Психологія" },
                    { 13, "Культура" },
                    { 14, "Мистецтво" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Hard Skills", 0 },
                    { 3, "Іноземні мови", 0 },
                    { 4, "Особистий розвиток", 0 },
                    { 5, "Підготовка до ЗНО", 0 },
                    { 6, "Підготовка до вступу", 0 },
                    { 7, "Підготовка до іспитів", 0 },
                    { 8, "Підвищення кваліфікації", 1 },
                    { 9, "Підвищення рівня знань", 1 },
                    { 10, "Підвищення рівня володіння іноземною мовою", 1 },
                    { 11, "Адміністрація", 2 },
                    { 12, "Бухгалтерія", 2 },
                    { 13, "Веб-розробка", 2 },
                    { 14, "Видавництво", 2 },
                    { 15, "Видавнича справа", 2 },
                    { 16, "Початковий", 3 },
                    { 17, "Середній", 3 },
                    { 18, "Високий", 3 },
                    { 19, "Дуже високий", 3 }
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentCourse_PaymentMethodId",
                table: "StudentCourse",
