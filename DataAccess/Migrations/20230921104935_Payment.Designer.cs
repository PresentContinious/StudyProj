...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230921104935_Payment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LessonStudentCourse", b =>
                {
                    b.Property<int>("CompletedLessonsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CompletedLessonsId", "StudentCoursesCourseId", "StudentCoursesStudentId");

                    b.HasIndex("StudentCoursesCourseId", "StudentCoursesStudentId");

                    b.ToTable("LessonStudentCourse");
                });
            ...
            modelBuilder.Entity("LessonStudentCourse", b =>
                {
                    b.HasOne("DataAccess.Models.Lesson", null)
                        .WithMany()
                        .HasForeignKey("CompletedLessonsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccess.Models.StudentCourse", null)
                        .WithMany()
                        .HasForeignKey("StudentCoursesCourseId", "StudentCoursesStudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
